...
<body class="body-content">
  ...
  <br><br>
  <div class="row">
  <div class="col offset-s6 "><div class="content-header">Hello  <?php
     $em=$_SESSION["email"];
   $sql = "select fname from patientinfo where pat_email = '$em'";  
   $rs=mysqli_query($conn, $sql);
   while($row=mysqli_fetch_row($rs)){
  ...
  <br><br><a href="appointments.php" class="waves-effect waves-light btn "style="width:40vw;"><i class="material-icons right">person</i>Book Appointment</a>
  </div></div>
